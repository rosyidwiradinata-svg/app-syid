...
def load_vcf():
    global contacts, file_paths, base_name, start_number
    ...
    try:
        start_number = int(simpledialog.askstring("Mulai Nomor", "Masukkan nomor awal:"))
    ...
    contact_counter = start_number  # Mulai dari nomor yang diinput
