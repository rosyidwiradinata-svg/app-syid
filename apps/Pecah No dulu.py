            ...
            for index, line in enumerate(lines):
                ...
                if phone:
                    ...
                    if cleaned_phone:
                        ...
                        numbered_contact_name = f"{contact_number}{contact_name}"
                        
                        if contact_number % contacts_per_file == 1:
                            if vcf_file:
                                vcf_file.close()
                            # Penamaan file diubah agar angka berada di depan nama file dasar
                            vcf_file_path = os.path.join(output_folder, f"{file_number}{file_base_name}.vcf")
